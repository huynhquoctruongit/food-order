...
const ReportByAdmin = () => {
  ...
  console.log(reciptData,currentSelect?.[0],profile?.company);
        ...
        <Table>
          ...
          <TableBody className="border-l-[1px] border-l-pastel-pink border-r-[1px] border-r-pastel-pink">
            {groupedData?.map((userItem, index) => {
              ...
              return (
                <TableRow
                  className={`${index % 2 == 0 ? "bg-pastel-pink/30" : "bg-white"} hover:bg-unset`}
                              ...
                              {(riceList?.length && (
                                <div className="flex items-center">
                                  <input
                                    ...
                                    disabled
                                    className="w-[50%] rounded-md p-[6px] text-center bg-transparent text-gray-600 select-none"
                                    value={finalPrice}
                                  ></input>
