...
const buttonVariants = cva(
  "focus-visible:outline-none font-bold rounded-full focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-[#FA9382] to-[#E5624D] text-white hover:shadow-button duration-200",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-gradient-to-br from-[#188E7E] to-[#188E7E] text-white hover:shadow-button2 duration-200",
