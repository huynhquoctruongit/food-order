  ...
  return (
    <div className="text-left">
      <BackgroundGradientAnimation>
        <div className="h-fit bg-gradient-to-tr to-pastel-pink/10 from-primary-01/5 flex items-center justify-center min-h-[calc(100vh-52px)] w-screen relative">
          ...
          <div className="p-4 relative z-10 flex flex-col gap-12">
            ...
            <AnimateView delay={1} className="flex items-center justify-center gap-10">
