        ...
        {listFood?.map((elm, index) => {
          ...
          return (
            <div
              ...
              className="rounded-lg border border-gray-300  w-[calc((100%-60px)/3)] flex items-center gap-2 hover:border-pastel-pink hover:shadow-button-small duration-200 cursor-pointer"
            >
